          ...
          <div className="flex space-x-3">
            {[
              ...
              <Link
                key={social.href}
                href={social.href}
                className="text-gray-300 hover:text-teal-400 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 focus:ring-offset-gray-900 rounded"
                target="_blank"
